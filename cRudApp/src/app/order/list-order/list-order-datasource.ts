...
const EXAMPLE_DATA: ListOrderItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
 ...
 */
export class ListOrderDataSource extends DataSource<ListOrderItem> {
  data: ListOrderItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<ListOrderItem[]> {
